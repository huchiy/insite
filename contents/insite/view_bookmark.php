...
<?
	$result_collection=query("select * from Pka_Collection where (1=1) and token_val='$rows_bookmark[token_val]' order by PU_joindate desc limit 0, 100");
...
?>
			<li>
				...
				<?if($rows_collection[token_val]==$_SESSION[p_token_val]){//자기글 조회?>
