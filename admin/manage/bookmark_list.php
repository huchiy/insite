                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped jambo_table bulk_action">
                                        ...
                                        <tr class="headings">
                                            ...
                                            <th class="column-title " style="text-align: center;">북마크사진</th>
                                            <th class="column-title " style="text-align: center;">북마크제목</th>
										 ...
										 <tr class="even pointer cls_<?=$article_num?>" bgcolor="<?=$lt_bg?>" onmouseover="this.style.backgroundColor='#EBEEF5';" onmouseout="this.style.backgroundColor='<?=$lt_bg?>';">
											...
											<td><!-- <?
												if($Pfiles[1]){
													...
													echo "<img src='/files/collection_thumb/{$img_Name}.thumb' border='0' width='50px'/>";
												}else{
													echo "<img src='/assets/images/temp_img/temp_01.jpg' border='0' width='50px'>";
												}
											?> --></td>
											<td><?=$rows[PU_subject]?></td>
											<td><?=$rows[PU_email]?></td>
											<td><?=$rows[PU_joindate]?></td>
											<td><a onClick="activeBtn('todayinsite_ok','<?=$rows[PB_idx]?>','today_bookmark');" style="padding:8px 2px;cursor:pointer;" class="blue_btn5">등록</a></td>
										 </tr>
<?$article_num--;
																			}?>
                                        </tbody>
